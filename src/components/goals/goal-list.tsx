...
export const GoalList = () => {
  ...
  const filteredGoals = goals
    .filter((goal) => {
      ...
      if (
        searchQuery &&
        !goal.note.toLowerCase().includes(searchQuery.toLowerCase())
      ) {
        return false;
      }
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="mb-2 text-4xl font-bold text-white">Goals</h1>
          <p className="text-gray-400">
            Manage student learning goals and objectives
          </p>
        </div>
        <Link href="/goals/add">
                  ...
                  >
                    ...
                    <TableCell>
                      <div className="flex space-x-2">
                        ...
                        <Dialog
                          open={deleteDialogOpen === goal._id}
                          onOpenChange={(open) =>
                            setDeleteDialogOpen(open ? goal._id : null)
                          }
                        >
                  ...
                  <TableCell colSpan={7} className="py-12 text-center">
                    <div className="text-gray-400">
                      {hasActiveFilters ? (
                        ...
                        <>
                          <p className="mb-2 text-lg">No goals yet</p>
                          <p className="text-sm">
