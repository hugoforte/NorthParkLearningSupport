          ...
          <div className="grid grid-cols-2 gap-2">
            <Link href={`/goals/add?studentId=${student._id}`}>
              <Button
                variant="outline"
                size="sm"
                className="w-full border-blue-600 text-xs text-blue-400 hover:bg-blue-600 hover:text-white"
              >
                Add Goal
              </Button>
            </Link>
            <Link href={`/notes/add?studentId=${student._id}`}>
              <Button
                variant="outline"
                size="sm"
                className="w-full border-green-600 text-xs text-green-400 hover:bg-green-600 hover:text-white"
              >
                Add Note
              </Button>
            </Link>
