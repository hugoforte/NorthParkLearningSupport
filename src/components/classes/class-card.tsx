    ...
    <Card className="hover:bg-gray-750 border-gray-700 bg-gray-800 transition-colors">
      ...
      <CardContent>
        {classItem.description && (
          <p className="mb-4 text-sm text-gray-300">{classItem.description}</p>
        )}

        {/* Assigned Teachers */}
        {assignments && assignments.length > 0 && (
          <div className="mb-4">
            <p className="mb-2 text-xs text-gray-400">Assigned Teachers:</p>
                ...
                <DialogContent>
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      ...
                      <strong>{classItem.name}</strong>? This will mark it as
                      inactive but preserve all data.
                    </DialogDescription>
                  </DialogHeader>
                  <DialogFooter>
                    <Button
